...
<svelte:head>
	<title>Contact Me | A Dead Inside Artist and Their Work</title>
	<meta name="title" content="Contact Me | A Dead Inside Artist and Their Work">
</svelte:head>
...
<Base>
    ...
    <section class="center">
        ...
        <p>
            You can email me at:<br><code>howdy [at] deadinsideartist [dot] art</code>
        </p>
        <p>
            You can message me on:<br>
	...
	<Quote quote="I order the food, you cook the food, the customer gets the food. We do that for forty years and then we die." person="Squidward Tentacles" media="SpongeBob SquarePants"/>
